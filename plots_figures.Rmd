...
bsmod4.tres14.2$type= rep(c("trunc-normal","log-normal"),each=84)
g1 <- ggplot(bsmod4.tres14.2[-c(1:8,65:80,153:168),], aes(lead,value))+geom_line(aes(colour=model,linetype=type))+ggtitle(paste0("Threshold ",thres,ifelse(i==1,", coastal stations"," m/s, land stations")))+scale_x_continuous(name="lead time",breaks=seq(6,48,by=6)) + geom_hline(aes(yintercept=0))+ theme_grey(base_size=12)+scale_y_continuous(name="Brier Skill Score")+geom_line(data=bsmod4.tres14.2[c(1:8),],aes(lead,value),color="darkred" ,size=1.5,linetype=3)
...
boxplot(boot.bs.mod2.new[[1]][[i]][boot.bs.mod2.new[[1]][[i]]>-100],
        ...
        boot.bs.mod7.6.new[[1]][[i]][boot.bs.mod7.6.new[[1]][[i]]>-100],
     ylim=c(-0.5,1),   main= paste0("Lead time ", sprintf("%02d",seq(6,48,by=6))[i],"h"),ylab="Brier Skill Score" ,names=c("Model 2","Model 3","Model 4.1","Model 4.2","Model 4.3","Model 4.4","Model 4.5","Model 4.6","Model 5","Model 6", "Model 7.1","Model 7.2","Model 7.3","Model 7.4","Model 7.5","Model 7.6"),las=2)}
```
...
par(cex.axis=1.5)
for(i in 1:8){
boxplot(boot.bs.mod2.new[[2]][[i]],boot.bs.mod5.new[[2]][[i]],boot.bs.mod3.new[[2]][[i]],boot.bs.mod6.new[[2]][[i]],  boot.bs.mod4.1.new[[2]][[i]] ,boot.bs.mod4.2.new[[2]][[i]] ,boot.bs.mod4.3.new[[2]][[i]] ,boot.bs.mod4.4.new[[2]][[i]], boot.bs.mod4.5.new[[2]][[i]],boot.bs.mod4.6.new[[2]][[i]], boot.bs.mod7.1.new[[2]][[i]] ,boot.bs.mod7.2.new[[2]][[i]] ,boot.bs.mod7.3.new[[2]][[i]] ,boot.bs.mod7.4.new[[2]][[i]],boot.bs.mod7.5.new[[2]][[i]],boot.bs.mod7.6.new[[2]][[i]] ,ylim=c(-0.5,1),   main= paste0("Lead time ", sprintf("%02d",seq(6,48,by=6))[i],"h"),ylab="Brier Skill Score" ,names=c("Model 2","Model 3","Model 4.1","Model 4.2","Model 4.3","Model 4.4","Model 4.5","Model 4.6","Model 5","Model 6", "Model 7.1","Model 7.2","Model 7.3","Model 7.4","Model 7.5","Model 7.6"),las=2)}
